...
** Setup the client
   ...
   To start using the SDK, require =simplyrets= and configure a client
   by setting your API key and API secret (we have demo credentials
...
** Examples: Making Requests
   ...
   Once you have the API Client instantiated you can use the
