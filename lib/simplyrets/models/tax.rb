...
module SimplyRetsClient
  ...
  class Tax
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'taxYear')
        self.tax_year = attributes[:'taxYear']
      end

      if attributes.has_key?(:'taxAnnualAmount')
        self.tax_annual_amount = attributes[:'taxAnnualAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tax_year == o.tax_year &&
          tax_annual_amount == o.tax_annual_amount &&
          id == o.id
    end
    ...
    def hash
      [tax_year, tax_annual_amount, id].hash
    end
