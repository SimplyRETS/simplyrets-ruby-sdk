...
# Unit tests for SimplyRetsClient::GeographicData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GeographicData' do
  before do
    # run before each test
    @instance = SimplyRetsClient::GeographicData.new
  end
  ...
  describe 'test an instance of GeographicData' do
    it 'should create an instact of GeographicData' do
      @instance.should be_a(SimplyRetsClient::GeographicData)
    end
  end
  ...
  describe 'test attribute "market_area"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
