...
# Unit tests for SimplyRetsClient::Listing
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Listing' do
  before do
    # run before each test
    @instance = SimplyRetsClient::Listing.new
  end
  ...
  describe 'test an instance of Listing' do
    it 'should create an instact of Listing' do
      @instance.should be_a(SimplyRetsClient::Listing)
    end
  end
  describe 'test attribute "private_remarks"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "mls_id"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "showing_instructions"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "mls"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
